    ...
    return new MaterialApp(
      ...
      home: Scaffold(
        ...
        body:   ListView(
          children: <Widget>[
            ListTile(
                title: Text('2020 공과대학 선거',style: TextStyle(fontSize: 20,color:Color.fromARGB(255, 0, 110, 56))),
            ...
            Padding(
              padding: const EdgeInsets.fromLTRB(16, 0, 16, 0),
                child: Text("2020년 공과대학 학생선거입니다. 공과대학교를 대표하는 학생 회장과 학생 부회장을 선출하는 투표입니다.",style: TextStyle(fontSize: 16))),
            Padding(
              padding: const EdgeInsets.all(16.0),
            ...
            Padding(
              ...
              child: new RaisedButton(
                  ...
                  onPressed: (){ if(globals.completed_2019_eltec == true){
                    _mainvotepopup();
                  } else{
                    Navigator.push(context,
                      MaterialPageRoute<void>(builder: (BuildContext context) {
