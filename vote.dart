            ...
            builder: (context) {
              return AlertDialog(
                ...
                actions: <Widget>[
                  ...
                  FlatButton(
                    onPressed: () {
                      globals.completed_2019_eltec = true;
    ...
    return new MaterialApp(// 구글 기본 디자인인 Material Design을 써서 앱을 만든다.
        ...
        home: Scaffold(
          appBar: new AppBar(
              ...
              title: Text("2020 공과대학 선거", style: TextStyle(color: Color.fromARGB(250, 114, 114, 114)),),
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text("2020 공과대학 선거",style: TextStyle(fontSize: 18)),
                ),
                Container(
